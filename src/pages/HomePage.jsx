  ...
  return (
    ...
    >
      ...
      <div className="pl-1 pr-1">
        <h6
          className={`${darkTheme ? "text-white" : "text-black"} text-4xl text-center pt-15`}
        >
          ...
          {[ablcc, dune, matrix, misslonely, swinggirls].map((src, i) => (
            <img
              ...
              className={`w-55 sm:w-48 md:w-60 h-90 sm:h-80 md:h-96 rounded-md absolute
                ...
                ${
                  i === 0
                    ? "-rotate-20 -bottom-5 sm:-bottom-16 md:-bottom-20 -translate-x-20 sm:-translate-x-36 md:-translate-x-72 z-10 hover:-bottom-5"
                    : i === 1
                      ? "-rotate-20 md:-rotate-10 md:bottom-0 bottom-8 -translate-x-10 sm:-translate-x-24 md:-translate-x-36 z-20 hover:bottom-10"
                      : i === 2
                        ? "rotate-0 bottom-15 sm:bottom-5 md:bottom-10 translate-x-0 z-30 hover:bottom-15"
                        : i === 3
                          ? "rotate-20 bottom-8 md:bottom-0 md:rotate-10 translate-x-10 sm:translate-x-24 md:translate-x-36 z-20 hover:bottom-10"
